...
import WishListBtnAddItem from "@/components/Common/WishListBtnAddItem";
...
const MyItem: React.FC<ItemProps> = ({ product }) => {
  return (
    <div className="flex justify-center">
      <div>
        <Link
          href="/product/[id]-[name]/edit"
          as={`/product/${product._id}-${product.name}/edit`}
          shallow
        >
